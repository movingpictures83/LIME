...
class LIMEPlugin:
 def input(self, infile):
     self.categories = PyIO.readSequential(infile)
 ...
 def output(self, outfile):
  ...
  newsgroups_train = fetch_20newsgroups(subset='train', categories=self.categories)
  newsgroups_test = fetch_20newsgroups(subset='test', categories=self.categories)
  #class_names = ['atheism', 'christian']
  class_names = []
  for category in self.categories:
      class_names.append(category[category.rfind('.')+1:])
